...
INSERT IGNORE INTO programa (IdPrograma, Programa, IdTipoP) VALUES
  (1, 'Licenciatura en Desarrollo de Software', 1),
  (2, 'Licenciatura en Redes Informaticas', 1),
  (3, 'Licenciatura en Ingenieria Industrial', 1),
  (4, 'Licenciatura en Ingenieria Civil', 1),
  (5, 'Licenciatura en Ingenieria Electrica', 1),
  (6, 'Tecnico en Programacion', 2);
